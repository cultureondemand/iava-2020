...
drawStackChart(dummydata_cannabis);
drawHBarChart(dummydata_cannabis_comfort);
drawStackChart(dummydata_cannabis_discussed);
...
drawStackChart(data_health_pain,"svg94");
 ...
 */
 ...
 drawStackChart(data_mj_research,"svg112");
drawStackChart(data_mj_va_research,"svg113");
drawStackChart(data_mj_medicinal,"svg114");
drawStackChart(data_mj_legal,"svg115");

drawStackChart(data_cannabis,"svg116");

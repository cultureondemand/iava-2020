...
var data_income = [
{a:"Less than $19,999",b:3},
{a:"$20,000 - $39,999",b:10},
{a:"$40,000 - $59,999",b:14},
{a:"$60,000 - $79,999",b:14},
{a:"$80,000 - $99,999",b:13},
...
{a:"Less than $19,999",b:1},
{a:"$20,000 - $39,999",b:2},
{a:"$40,000 - $59,999",b:4},
{a:"$60,000 - $79,999",b:6},
{a:"$80,000 - $99,999",b:7},
{a:"$100,000 - $149,999",b:7},
{a:"More than $150,000",b:7},
{a:"Prefer Not to Answer",b:12}
];
...
var data_o=[{a:"Zero Deployments",b:78},{a:"One Deployment",b:20},{a:"Two Deployments",b:1},{a:"Three Deployments",b:.3},{a:"Four Deployments",b:.2},{a:"Five+ Deployments",b:0}];
...
var data_nfl_plan = [
{a:"Will not watch NFL games because I disagree with the protests",b:24},
{a:"Will keep watching/attending NFL games and support their right to protest in this way",b:28},
{a:"Will not watch because I'm not a NFL fan, but in general object to any protest during our national anthem",b:10},
{a:"Will keep watching NFL games, but disagree with the protest",b:15},
{a:"Will keep watching/attending NFL games, and have no opinion about the protests",b:4},
{a:"Will not watch because I'm not a NFL fan, but in general support their right to protest in this way.",b:16},
{a:"Will not watch because I'm not a NFL fan, but in general have no opinion about the protests",b:3}
];



var dummydata_nfl_plan = [
{a:"Will not watch NFL games because I disagree with the protests",b:50},
{a:"Will keep watching/attending NFL games and support their right to protest in this way",b:23},
{a:"Will not watch because I'm not a NFL fan, but in general object to any protest during our national anthem",b:12},
{a:"Will keep watching NFL games, but disagree with the protest",b:5},
{a:"Will keep watching/attending NFL games, and have no opinion about the protests",b:5},
{a:"Will not watch because I'm not a NFL fan, but in general support their right to protest in this way.",b:5},
{a:"Will not watch because I'm not a NFL fan, but in general have no opinion about the protests",b:10}
];
...
{a:"Don't have place to live and can't afford one",b:31},
...
{a:"Somewhat satisfied",b:14},
{a:"Extremely satisfied",b:11}
];
...
{a:"Somewhat satisfied",b:22},
{a:"Extremely satisfied",b:16}
];
...
{a:"Somewhat satisfied",b:15},
{a:"Extremely satisfied",b:13}
];
...
var data_employed=[{a:"Self-employed business owner",b:5},{a:"Employed full-time",b:57},{a:"Employed part-time",b:4},{a:"Student",b:5},{a:"Unemployed and not looking for work",b:1},{a:"Unemployed and looking for work",b:5},{a:"Retired",b:10},{a:"Disabled or otherwise unable to work",b:12},{a:"Prefer not to answer",b:1}];

var dummydata_employed=[{a:"Self-employed business owner",b:14},{a:"Employed full-time",b:5},{a:"Employed part-time",b:3},{a:"Student",b:8},{a:"Unemployed and not looking for work",b:5},{a:"Unemployed and looking for work",b:19},{a:"Retired",b:6},{a:"Disabled or otherwise unable to work",b:6},{a:"Prefer not to answer",b:6}];
...
var dummydata_level = [
{a:"Entry Level",b:11},
{a:"Associate Level",b:11},
{a:"Junior Management",b:11},
{a:"Senior Management",b:11},
{a:"Executive Level or Business Owner",b:19}
];
...
{a:"Start up capital",b:18},
{a:"Can't qualify for loans",b:10},
{a:"Lack of industry experience",b:16},
{a:"Navigating federal and state regulations",b:16},
{a:"Operating costs",b:16},
{a:"Lack of available training",b:16},
{a:"Other",b:10}
];
...
startnumerosB(numero_afghan_visa,"svg36");
...
startnumerosA(numero_deport_impacted,"svg39");

startnumerosB(numero_deport_know,"svg40");
...
startnumerosA(numero_perm,"svg63");
 ...
 changeHBarChart(data_tran_current,"svg66");
  ...
  changeHBarChart(data_tran_challenges,"svg71");

  drawStackChart(data_tran_familiar,"svg72");

  changeHBarChart(data_benefits_influential,"svg73");
...
startsmallnumerosA(numero_suicide_know_died,"svg76");
  ...
  changeHBarChart(data_mental_considered,"svg77");
  drawStackChart(data_mental_considered_before,"svg78");
...
///////////////   changeHBarChart(data_mental_help_why,"svg82");
  ...
  drawStackChart(data_mental_injury,"svg82");

  drawStackChart(data_mental_help,"svg83");
  changeHBarChart(data_mental_help_where,"svg84");
...
////////////  changeHBarChart(data_mental_help_not,"svg86");
  ...
  drawStackChart(data_mental_help_suggest,"svg85");
  drawStackChart(data_mental_help_sought,"svg86");
...
changePieChart(data_health_before,"svg87");
changePieChart(data_health_after,"svg88");
changePieChart(data_health_importance,"svg89");
...
startnumerosA(numero_health_injury,"svg90");
startnumerosB(numero_health_pain,"svg91");


changeHBarChart(dummydata_health_a,"svg92");



changeHBarChart(data_health_affect,"svg93");
...
changeHBarChart(data_health_sleep,"svg94");
...
drawStackChart(data_health_sleep_trouble,"svg95");
drawStackChart(data_health_sleep_diagnosed,"svg96");

drawStackChart(data_health_exercise,"svg97");

drawStackChart(data_health_exercise_often,"svg98");

changeHBarChart(data_health_medication,"svg99");

changeHBarChart(data_health_therapies,"svg100");

drawStackChart(data_health_therapies_result,"svg101");
drawStackChart(data_health_assisting,"svg102");

changeHBarChart(data_health_assisting_who,"svg103");
drawStackChart(data_health_activities,"svg104");
...
iii=105;
 ...
 startnumerosA(numero_burn_pit,"svg105");

////////changeStackChart(data_burn,"svg106");


changeStackChart(data_burn_symptoms,"svg106");
changeStackChart(data_burn_registry,"svg107");
changeHBarChart(data_burn_registered,"svg108");
changeStackChart(data_burn_issues,"svg109");
 ...
 */
 ...
 drawStackChart(data_mj_research,"svg110");
drawStackChart(data_mj_va_research,"svg111");
drawStackChart(data_mj_medicinal,"svg112");
drawStackChart(data_mj_legal,"svg113");

drawStackChart(data_cannabis,"svg114");

drawStackChart(data_mj_treatment,"svg115");
changeHBarChart(data_cannabis_comfort,"svg116");
drawStackChart(data_cannabis_discussed,"svg117");


changePieChart(data_cannabis_recreational,"svg118");
changePieChart(data_cannabis_legal_med,"svg119");
changePieChart(data_cannabis_legal_rec,"svg120");
...
changeStackChart(data_tobacco,"svg121");
changeHBarChart(data_tobacco_type,"svg122");
 
drawStackChart(data_tobacco_use,"svg123");
changeHBarChart(data_tobacco_often,"svg124");

changeHBarChart(data_alcohol,"svg125");

changeHBarChart(data_alcohol_max,"svg126");
...
///////////////changeHBarChart(data_alcohol_twohour,"svg127");
 ...
 startnumerosA(numero_data_alcohol,"svg127");
...
drawStackChart(data_wom_iava,"svg128");
changeHBarChart(data_wom_motto,"svg129");
 
drawStackChart(data_wom_positions,"svg130");
drawStackChart(data_wom_positions_m,"svg131");
drawStackChart(data_wom_positions_f,"svg132");

 drawStackChart(data_wom_combat,"svg133");
 drawStackChart(data_wom_combat_m,"svg134");
 drawStackChart(data_wom_combat_f,"svg135");
 
 
drawStackChart(data_wom_recognition,"svg136");
drawStackChart(data_wom_recognition_m,"svg137");
drawStackChart(data_wom_recognition_f,"svg138");
...
*/
 ...
 startnumerosB(numero_mst,"svg139");
 
 drawStackChart(data_wom_prosecutor,"svg140");

drawStackChart(data_wom_survivor,"svg141");

 drawStackChart(data_wom_report,"svg142");

changeHBarChart(data_wom_impact,"svg143");
 drawStackChart(data_wom_retaliation,"svg144");
...
iii=145;
 ...
 startnumerosA(numero_other,"svg145");

 startnumerosB(numero_enrolled,"svg146");
...
/////////////////////  changeHBarChart(data_wom_not_report,"svg144");
  ...
  changeHBarChart(data_va_coverage,"svg147");

 changeStackChart(data_va_primary,"svg148");

  changeHBarChart(data_va_last,"svg149");
 changeStackChart(data_va_experience,"svg150");
...
changeStackChart(data_va_non_quality,"svg152");


 changeStackChart(data_va_understand,"svg153");
 changeStackChart(data_va_non_understand,"svg154");
 ...
 changeStackChart(data_va_scheduling_prim,"svg155");
 changeStackChart(data_va_scheduling_mental,"svg156");
 changeStackChart(data_va_scheduling_special,"svg157");


 changeStackChart(data_va_satisfaction_prim,"svg158");
 changeStackChart(data_va_satisfaction_special,"svg159");
 changeStackChart(data_va_satisfaction_mental,"svg160");

 changeStackChart(data_va_scheduling_non_prim,"svg161");
 changeStackChart(data_va_scheduling_non_mental,"svg162");
 changeStackChart(data_va_scheduling_non_spec,"svg163");
...
////////////     changeHBarChart(data_va_choose,"svg164");
 ...
 changeStackChart(data_va_familiar,"svg164");
 changeStackChart(data_va_choice,"svg165");
  changeStackChart(data_va_choice_exp,"svg166");

  startnumerosB(numero_va_mission,"svg167");

 changeStackChart(data_va_private,"svg168");
...
iii=169;
  ...
  changeStackChart(data_va_rating,"svg169");
 
  changeHBarChart(data_va_claim_long,"svg170");

  changeHBarChart(data_va_pending,"svg171");
 
  changeStackChart(data_va_outcome,"svg172");

  changeStackChart(data_va_appeal,"svg173");
 
  changeHBarChart(data_va_decision,"svg174");

  changeHBarChart(data_va_appeal_pending,"svg175");
 
 
 
  changeStackChart(data_va_rate_dis,"svg176");
  changeStackChart(data_va_rate_pension,"svg177");
  changeStackChart(data_va_rate_edu,"svg178");
  changeStackChart(data_va_rate_home,"svg179");
  changeStackChart(data_va_rate_ins,"svg180");
  changeStackChart(data_va_rate_voc,"svg181");
  changeStackChart(data_va_rate_care,"svg182");

 

  changeHBarChart(data_va_ask,"svg183");
...
function showTitle19(){
 iii=184;
   ...
   changeStackChart(data_gi_eligible,"svg184");

  changeHBarChart(data_gi_use,"svg185");

  changeStackChart(data_gi_grad,"svg186");
  changeStackChart(data_gi_exp,"svg187");
 
 changeStackChart(data_gi_imp_recruit,"svg188");
  changeStackChart(data_gi_imp_retent,"svg189");
  changeStackChart(data_gi_imp_trans,"svg190");
...
*/
 ...
 startnumerosA(numero_ed_a,"svg191");
startnumerosB(numero_ed_b,"svg192");
startnumerosC(numero_ed_c,"svg193");
 
  changeStackChart(data_ed_b,"svg194");
  changeHBarChart(data_ed_c,"svg195");
  changeStackChart(data_ed_vetfriend,"svg196");
 //// changeStackChart(data_ed_a,"svg198");
   changeHBarChart(data_ed_a,"svg197");

 startnumerosB(numero_ed_d,"svg198");
 
   changeHBarChart(data_ed_d,"svg199");
...
function showTitle21(){
 ...
 iii=200;
   ...
   changeHBarChart(data_employed,"svg200");
   drawStackChart(data_traing,"svg201");
   drawStackChart(data_job_before,"svg202");
   changeHBarChart(data_without_job,"svg203");
   changeHBarChart(data_level,"svg204");
   drawStackChart(data_satisfied,"svg205");
    ///////////////////////////////////////////////
 // removing
 /////////////////////////////////////////////////
...
////////////      changeHBarChart(data_dissatisfied,"svg207");
 startnumerosB(numero_underemployed,"svg206");
  startnumerosC(numero_unemployed,"svg207");
...
////////////      changeHBarChart(data_looking,"svg211");
   ...
   drawStackChart(data_startup,"svg208");
    changeHBarChart(data_startup_challenges,"svg209");
 startnumerosB(numero_employ_loans,"svg210");

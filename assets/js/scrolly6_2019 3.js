...
startnumerosA(numero_mental_care,"svg81");
  ...
  changeHBarChart(data_mental_help_where,"svg85");
...
startnumerosA(numero_health_injury,"svg92");
startnumerosB(numero_health_pain,"svg93");


changeHBarChart(dummydata_health_a,"svg94");



changeHBarChart(data_health_affect,"svg95");

drawStackChart(data_health_sleep_trouble,"svg96");
drawStackChart(data_health_sleep_diagnosed,"svg97");

drawStackChart(data_health_exercise,"svg98");

drawStackChart(data_health_exercise_often,"svg99");

changeHBarChart(data_health_medication,"svg100");

changeHBarChart(data_health_therapies,"svg101");

drawStackChart(data_health_therapies_result,"svg102");
drawStackChart(data_health_assisting,"svg103");

changeHBarChart(data_health_assisting_who,"svg104");
drawStackChart(data_health_activities,"svg105");
...
iii=106;
 ...
 startnumerosA(numero_burn_pit,"svg106");
...
changeHBarChart(data_burn_registered,"svg109");
 ...
 */
 ...
 drawStackChart(data_mj_research,"svg111");
drawStackChart(data_mj_va_research,"svg112");
drawStackChart(data_mj_medicinal,"svg1134");
drawStackChart(data_mj_legal,"svg114");

drawStackChart(data_cannabis,"svg115");

drawStackChart(data_mj_treatment,"svg116");
changeHBarChart(data_cannabis_comfort,"svg117");
drawStackChart(data_cannabis_discussed,"svg118");
...
drawStackChart(data_tobacco_use,"svg124");
...
drawStackChart(data_wom_iava,"svg130");
changeHBarChart(data_wom_motto,"svg131");
 
drawStackChart(data_wom_positions,"svg132");
...
*/
 ...
 drawStackChart(data_wom_prosecutor,"svg136");

drawStackChart(data_wom_survivor,"svg137");

 drawStackChart(data_wom_report,"svg138");

changeHBarChart(data_wom_impact,"svg139");
 drawStackChart(data_wom_retaliation,"svg140");
...
iii=142;
 ...
 startnumerosA(numero_other,"svg142");

 startnumerosB(numero_enrolled,"svg143");
 ...
 changeStackChart(data_va_experience,"svg148");
  ...
  changeStackChart(data_va_quality,"svg150");
changeStackChart(data_va_non_quality,"svg151");


 changeStackChart(data_va_understand,"svg152");
 changeStackChart(data_va_non_understand,"svg153");
...
startnumerosC(numero_ed_c,"svg194");
 ...
 //// changeStackChart(data_ed_a,"svg198");
   changeHBarChart(data_ed_a,"svg198");
...
function showTitle21(){
 ...
 iii=201;
   ...
   changeHBarChart(data_employed,"svg201");
   drawStackChart(data_traing,"svg202");
   drawStackChart(data_job_before,"svg203");
   changeHBarChart(data_without_job,"svg204");
   changeHBarChart(data_level,"svg205");
   drawStackChart(data_satisfied,"svg206");
   changeHBarChart(data_satisfied_why,"svg207");
   changeHBarChart(data_dissatisfied,"svg208");
 startnumerosB(numero_underemployed,"svg209");
  startnumerosC(numero_unemployed,"svg210");
...
/////changeStackChart(data_health_pain,"svg93");
//////changeHBarChart(data_health_a,"svg94");
...
////// startnumerosA(numero_cannabis,"svg111");
 ...
 changeStackChart(data_mj_research,"svg111");
changeStackChart(data_mj_va_research,"svg112");
changeStackChart(data_mj_medicinal,"svg113");
changeStackChart(data_mj_legal,"svg114");

changeStackChart(data_cannabis,"svg115");
  
  
 changeStackChart(data_mj_treatment,"svg116");
